...
import com.example.winkey.mydemos.view.fragment.ormlite.OrmliteQueryFragment;
...
public class OrmliteQueryActivity extends ToolbarActivity {
    private OrmliteQueryFragment mFragment;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, OrmliteQueryActivity.class);
    ...
    protected void parsentData() {
        mFragment = OrmliteQueryFragment.newInstance();
    }
