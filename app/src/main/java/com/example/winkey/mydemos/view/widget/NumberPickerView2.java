...
public class NumberPickerView2 extends View {
    ...
    @ColorInt
    private int mTextColorOption;//文字备选颜色
    ...
    public NumberPickerView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NumberPickerView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextColorOption = array.getColor(R.styleable.NumberPickerView_numberColorSelected, Color.GRAY);*/
        array.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int itemIndex = defaultValue; itemIndex < mPageSize+defaultValue+2; itemIndex++) {
            ...
            if (itemIndex == selectedPos) {
                ...
                mTextPaint.setTextSize(mTextSize-8);
            } else {
                mTextPaint.setColor(mTextColorOption);
                mTextPaint.setTextSize(mTextSize-16 );
            }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                Logger.debug("mLastTouchY:" + mLastTouchY);
   ...
   /* *//**
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (position != oldPos)
            if (mCallbackRef != null) {
                mCallbackRef.onValueChanged(position, mSelector[position - defaultValue]);
                oldPos = position;
            }
    ...
    private boolean canScroll(int deltaY) {
        ...
        Logger.debug("deltaY:" + deltaY + ";scrollY:" + scrollY + ";top:" + top + ";bottom:" + bottom);
